...
CLASSPATH=${CLASSPATH}":${IGINX_HOME}/iotdb/target/iotdb-0.1.0-SNAPSHOT.jar"":${IGINX_HOME}/influxdb/target/influxdb-0.1.0-SNAPSHOT.jar"":${IGINX_HOME}/tdengine/target/tdengine-0.1.0-SNAPSHOT.jar"
