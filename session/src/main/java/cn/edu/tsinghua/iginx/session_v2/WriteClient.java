...
public interface WriteClient {
    ...
    void writePoints(final List<Point> points, final TimePrecision timePrecision) throws IginXException;
    ...
    void writeRecords(final List<Record> records, final TimePrecision timePrecision) throws IginXException;

    <M> void writeMeasurement(final M measurement) throws IginXException;

    <M> void writeMeasurement(final M measurement, final TimePrecision timePrecision) throws IginXException;

    <M> void writeMeasurements(final List<M> measurements) throws IginXException;

    <M> void writeMeasurements(final List<M> measurements, final TimePrecision timePrecision) throws IginXException;
