...
public class InfluxDBHistoryDataCapacityExpansionIT {
    ...
    public void testAddSameDataPrefixWithDiffSchemaPrefix() throws Exception {
        ...
        expect = "ResultSets:\n" +
                "+-------------+----------------------------------------------------------------+----------------------------------------------------------------+----------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------+\n" +
                "|         Time|expansion2.data_center.cpu.temperature{host=1,rack=A,room=ROOMA}|expansion2.data_center.cpu.temperature{host=2,rack=B,room=ROOMA}|expansion2.data_center.cpu.temperature{host=4,rack=B,room=ROOMB}|expansion2.data_center.cpu.usage{host=1,rack=A,room=ROOMA}|expansion2.data_center.cpu.usage{host=2,rack=B,room=ROOMA}|expansion2.data_center.cpu.usage{host=4,rack=B,room=ROOMB}|\n" +
                "+-------------+----------------------------------------------------------------+----------------------------------------------------------------+----------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------+\n" +
                "|1000000000000|                                                            56.4|                                                            55.1|                                                            null|                                                      66.3|                                                      72.1|                                                      null|\n" +
                "|1300000000000|                                                            56.2|                                                            null|                                                            99.8|                                                      67.1|                                                      null|                                                      22.1|\n" +
                "+-------------+----------------------------------------------------------------+----------------------------------------------------------------+----------------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------+----------------------------------------------------------+\n" +
