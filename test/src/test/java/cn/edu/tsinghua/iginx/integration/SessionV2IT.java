...
//        asyncInsertDataByMeasurements();
  ...
  public void testUserClient() {
    Set<AuthType> fullAuth = new HashSet<>(
        Arrays.asList(AuthType.Read, AuthType.Write, AuthType.Admin, AuthType.Cluster));
    Set<AuthType> rdsAuth = new HashSet<>(
        Arrays.asList(AuthType.Read, AuthType.Write, AuthType.Admin));
  ...
  public static class POJO {
    ...
    public POJO(long timestamp, boolean boolValue, int intValue, long longValue, float floatValue,
        double doubleValue, byte[] binaryValue) {
