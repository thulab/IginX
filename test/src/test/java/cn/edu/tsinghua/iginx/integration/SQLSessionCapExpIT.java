...
public abstract class SQLSessionCapExpIT {

    private static final Logger logger = LoggerFactory.getLogger(SQLSessionCapExpIT.class);
    ...
    @AfterClass
    public static void tearDown() throws ExecutionException, SessionException {
        try {
    ...
    public void testShowTimeSeries() {
        ...
        String statement = "SHOW TIME SERIES us.d1.*;";
        String expected =
                "Time series:\n"
                        + "+--------+--------+\n"
                        + "|    Path|DataType|\n"
        ...
        statement = "SHOW TIME SERIES us.d1.* limit 3;";
        expected =
                "Time series:\n"
                        + "+--------+--------+\n"
                        + "|    Path|DataType|\n"
        ...
        statement = "SHOW TIME SERIES us.d1.* limit 2 offset 1;";
        expected =
                "Time series:\n"
                        + "+--------+--------+\n"
                        + "|    Path|DataType|\n"
        ...
        statement = "SHOW TIME SERIES us.d1.* limit 1, 2;";
        expected =
                "Time series:\n"
                        + "+--------+--------+\n"
                        + "|    Path|DataType|\n"
...
//    }
    ...
    public void testDeleteTimeSeries() {
        ...
        String showTimeSeries = "SHOW TIME SERIES us.d1.*;";
        String expected =
                "Time series:\n"
                        + "+--------+--------+\n"
                        + "|    Path|DataType|\n"
        ...
        showTimeSeries = "SHOW TIME SERIES us.d1.*;";
        expected =
                "Time series:\n"
                        + "+--------+--------+\n"
                        + "|    Path|DataType|\n"
