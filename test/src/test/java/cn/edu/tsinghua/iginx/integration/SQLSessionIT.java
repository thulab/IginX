...
//        testFromMultiPath();
    ...
    public void testBasicArithmeticExpr() {
        ...
        String expected =
            "ResultSets:\n"
                + "+----+--------+--------+--------+\n"
                + "|Time|us.d3.s1|us.d3.s2|us.d3.s3|\n"
                + "+----+--------+--------+--------+\n"
                + "|   1|       1|       6|     1.5|\n"
                + "|   2|       2|       5|     2.5|\n"
                + "|   3|       3|       4|     3.5|\n"
        ...
        expected =
            "ResultSets:\n"
                + "+----+------------+------------+------------+\n"
                + "|Time|us.d3.s1 + 1|us.d3.s2 - 1|us.d3.s3 × 2|\n"
                + "+----+------------+------------+------------+\n"
                + "|   1|           2|           5|         3.0|\n"
                + "|   2|           3|           4|         5.0|\n"
                + "|   3|           4|           3|         7.0|\n"
        ...
        expected =
            "ResultSets:\n"
                + "+----+-------------------+-------------------+-------------------+-------------------+\n"
                + "|Time|us.d3.s1 + us.d3.s2|us.d3.s1 + us.d3.s3|us.d3.s1 - us.d3.s2|us.d3.s1 - us.d3.s3|\n"
                + "+----+-------------------+-------------------+-------------------+-------------------+\n"
                + "|   1|                  7|                2.5|                 -5|               -0.5|\n"
                + "|   2|                  7|                4.5|                 -3|               -0.5|\n"
                + "|   3|                  7|                6.5|                 -1|               -0.5|\n"
        ...
        expected =
            "ResultSets:\n"
                + "+----+-------------------+-------------------+-------------------+\n"
                + "|Time|us.d3.s1 % us.d3.s2|us.d3.s1 × us.d3.s2|us.d3.s1 ÷ us.d3.s2|\n"
                + "+----+-------------------+-------------------+-------------------+\n"
                + "|   1|                  1|                  6|                  0|\n"
                + "|   2|                  2|                 10|                  0|\n"
                + "|   3|                  3|                 12|                  0|\n"
        ...
        expected =
            "ResultSets:\n"
                + "+----+-------------------+-------------------+-------------------+\n"
                + "|Time|us.d3.s1 % us.d3.s3|us.d3.s1 × us.d3.s3|us.d3.s1 ÷ us.d3.s3|\n"
                + "+----+-------------------+-------------------+-------------------+\n"
                + "|   1|                1.0|                1.5| 0.6666666666666666|\n"
                + "|   2|                2.0|                5.0|                0.8|\n"
                + "|   3|                3.0|               10.5| 0.8571428571428571|\n"
                + "|   4|                4.0|               18.0| 0.8888888888888888|\n"
                + "|   5|                5.0|               27.5| 0.9090909090909091|\n"
                + "|   6|                6.0|               39.0| 0.9230769230769231|\n"
                + "+----+-------------------+-------------------+-------------------+\n"
                + "Total line number = 6\n";
        executeAndCompare(statement, expected);
    }
    ...
    public void testComplexArithmeticExpr() {
        ...
        expected =
            "ResultSets:\n"
                + "+----+---------------------------------------------+\n"
                + "|Time|(us.d3.s1 + us.d3.s3) × (us.d3.s2 - us.d3.s3)|\n"
                + "+----+---------------------------------------------+\n"
                + "|   1|                                        11.25|\n"
                + "|   2|                                        11.25|\n"
                + "|   3|                                         3.25|\n"
        ...
        expected =
            "ResultSets:\n"
                + "+----+--------------------------------------------------------+\n"
                + "|Time|((us.d3.s1 + us.d3.s2) × us.d3.s3 + us.d3.s2) × us.d3.s3|\n"
                + "+----+--------------------------------------------------------+\n"
                + "|   1|                                                   24.75|\n"
                + "|   2|                                                   56.25|\n"
                + "|   3|                                                   99.75|\n"
