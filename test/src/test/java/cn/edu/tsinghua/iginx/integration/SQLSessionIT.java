...
//                "DownsampleQuery ResultSets:\n" +
//                        "+----+---------------------+---------------------+\n" +
//                        "|Time|FIRST_VALUE(us.d1.s4)|FIRST_VALUE(us.d1.s1)|\n" +
//                        "+----+---------------------+---------------------+\n" +
//                        "|   1|                  1.1|                    1|\n" +
//                        "| 101|                101.1|                  101|\n" +
//                        "| 201|                201.1|                  201|\n" +
...
//                "DownsampleQuery ResultSets:\n" +
//                        "+----+------------------+------------------+\n" +
//                        "|Time|     AVG(us.d1.s4)|     AVG(us.d1.s1)|\n" +
//                        "+----+------------------+------------------+\n" +
//                        "|   1|              50.6|              50.5|\n" +
//                        "| 101|150.60000000000002|150.50000000000006|\n" +
//                        "| 201|250.59999999999997| 250.4999999999999|\n" +
//                        "| 301|350.60000000000014|             350.5|\n" +
//                        "| 401| 450.6000000000001| 450.4999999999998|\n" +
//                        "| 501| 550.6000000000001| 550.5000000000003|\n" +
//                        "| 601| 650.6000000000001|             650.5|\n" +
//                        "| 701| 750.6000000000004| 750.5000000000002|\n" +
//                        "| 801| 850.6000000000001| 850.4999999999995|\n" +
//                        "| 901| 950.1000000000009|             950.0|\n" +
//                        "+----+------------------+------------------+\n" +
//                        "Total line number = 10\n",
//                "DownsampleQuery ResultSets:\n" +
//                        "+----+---------------+---------------+\n" +
