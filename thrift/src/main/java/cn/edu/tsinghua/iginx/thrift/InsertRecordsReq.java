...
public class InsertRecordsReq implements org.apache.thrift.TBase<InsertRecordsReq, InsertRecordsReq._Fields>, java.io.Serializable, Cloneable, Comparable<InsertRecordsReq> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.nio.ByteBuffer> attributes; // optional
  ...
  public InsertRecordsReq(InsertRecordsReq other) {
    ...
    if (other.isSetAttributes()) {
      java.util.Map<java.lang.String,java.nio.ByteBuffer> __this__attributes = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>(other.attributes);
  ...
  public void putToAttributes(java.lang.String key, java.nio.ByteBuffer val) {
    if (this.attributes == null) {
      this.attributes = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>();
    }
    this.attributes.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.nio.ByteBuffer> getAttributes() {
    return this.attributes;
  }

  public InsertRecordsReq setAttributes(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.nio.ByteBuffer> attributes) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ATTRIBUTES:
      if (value == null) {
        ...
        setAttributes((java.util.Map<java.lang.String,java.nio.ByteBuffer>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.attributes = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>(2*_map87.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key88;
                @org.apache.thrift.annotation.Nullable java.nio.ByteBuffer _val89;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InsertRecordsReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.paths != null) {
        oprot.writeFieldBegin(PATHS_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter91 : struct.paths)
          {
      ...
      if (struct.timestamps != null) {
        oprot.writeFieldBegin(TIMESTAMPS_FIELD_DESC);
        {
          ...
          for (long _iter92 : struct.timestamps)
          {
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.nio.ByteBuffer> _iter94 : struct.attributes.entrySet())
            {
              oprot.writeString(_iter94.getKey());
              oprot.writeBinary(_iter94.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class InsertRecordsReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<InsertRecordsReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, InsertRecordsReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.sessionId);
      {
        ...
        for (java.lang.String _iter95 : struct.paths)
        {
      ...
      }
      {
        ...
        for (long _iter96 : struct.timestamps)
        {
      ...
      }
      {
        ...
        for (java.nio.ByteBuffer _iter97 : struct.values)
        {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.nio.ByteBuffer> _iter98 : struct.attributes.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, InsertRecordsReq struct) throws org.apache.thrift.TException {
      ...
      struct.setSessionIdIsSet(true);
      {
        ...
        struct.paths = new java.util.ArrayList<java.lang.String>(_list99.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _elem100;
        for (int _i101 = 0; _i101 < _list99.size; ++_i101)
        {
          _elem100 = iprot.readString();
          struct.paths.add(_elem100);
        }
      }
      struct.setPathsIsSet(true);
      {
        org.apache.thrift.protocol.TList _list102 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.timestamps = new java.util.ArrayList<java.lang.Long>(_list102.size);
        long _elem103;
        for (int _i104 = 0; _i104 < _list102.size; ++_i104)
        {
          _elem103 = iprot.readI64();
          struct.timestamps.add(_elem103);
        }
      }
      struct.setTimestampsIsSet(true);
      {
        ...
        struct.values = new java.util.ArrayList<java.nio.ByteBuffer>(_list105.size);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.attributes = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>(2*_map108.size);
