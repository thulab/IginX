...
public class QueryDataResp implements org.apache.thrift.TBase<QueryDataResp, QueryDataResp._Fields>, java.io.Serializable, Cloneable, Comparable<QueryDataResp> {
  ...
  private static final _Fields optionals[] = {_Fields.PATHS,_Fields.QUERY_DATA_SET};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.paths = new java.util.ArrayList<java.lang.String>(_list128.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = iprot.readString();
                  struct.paths.add(_elem129);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.paths != null) {
        if (struct.isSetPaths()) {
          oprot.writeFieldBegin(PATHS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter131 : struct.paths)
            {
      ...
      if (struct.isSetPaths()) {
        {
          ...
          for (java.lang.String _iter132 : struct.paths)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.paths = new java.util.ArrayList<java.lang.String>(_list133.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = iprot.readString();
            struct.paths.add(_elem134);
          }
        }
        struct.setPathsIsSet(true);
      }
