            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.paths = new java.util.ArrayList<java.lang.String>(_list136.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem137;
                for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                {
                  _elem137 = iprot.readString();
                  struct.paths.add(_elem137);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.paths != null) {
        if (struct.isSetPaths()) {
          oprot.writeFieldBegin(PATHS_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter139 : struct.paths)
            {
      ...
      if (struct.isSetPaths()) {
        {
          ...
          for (java.lang.String _iter140 : struct.paths)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.paths = new java.util.ArrayList<java.lang.String>(_list141.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem142;
          for (int _i143 = 0; _i143 < _list141.size; ++_i143)
          {
            _elem142 = iprot.readString();
            struct.paths.add(_elem142);
          }
        }
        struct.setPathsIsSet(true);
      }
