        ...
        if (pattern.matcher(field.getName()).matches()) {
          if (groupByLevels == null) {
            if (DataTypeUtils.isWholeNumber(field.getType())) {
              targetFields
                  .add(new Field(getIdentifier() + "(" + field.getName() + ")", DataType.LONG));
            } else {
              targetFields
                  .add(new Field(getIdentifier() + "(" + field.getName() + ")", DataType.DOUBLE));
            }
          } else {
            String targetFieldName =
                getIdentifier() + "(" + GroupByUtils.transformPath(field.getName(), groupByLevels)
                    + ")";
