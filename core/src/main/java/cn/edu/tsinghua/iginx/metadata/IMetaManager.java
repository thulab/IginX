...
public interface IMetaManager {
   ...
   * 创建分片和存储单元
   */
  boolean createFragmentsAndStorageUnits(List<StorageUnitMeta> storageUnits,
   ...
   * 创建初始分片和初始存储单元
   */
  boolean createInitialFragmentsAndStorageUnits(List<StorageUnitMeta> storageUnits,
      List<FragmentMeta> initialFragments);
