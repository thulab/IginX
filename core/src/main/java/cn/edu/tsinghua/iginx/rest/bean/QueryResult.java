...
public class QueryResult {
  ...
  public String toAnnotationResultString(boolean isGrafana) {
    ...
    for (int i = 0; i < siz; i++) {
      Annotation ins = new Annotation(
          new String((byte[]) queryResultDatasets.get(0).getValues().get(i)),
  ...
  private Map<String, List<String>> getTagsFromPaths(String name, List<String> paths)
      throws Exception {
