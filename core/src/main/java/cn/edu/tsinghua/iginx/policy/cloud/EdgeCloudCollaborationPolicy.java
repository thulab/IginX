...
public class EdgeCloudCollaborationPolicy implements IPolicy {

    protected AtomicBoolean needReAllocate = new AtomicBoolean(false);

    private EdgeCloudCollaborationPlanSplitter iPlanSplitter;

    private IMetaManager iMetaManager;

    private EdgeCloudCollaborationFragmentGenerator iFragmentGenerator;
    ...
    public EdgeCloudCollaborationFragmentGenerator getFragmentGenerator() {
    ...
    public void init(IMetaManager iMetaManager) {
        ...
        this.iPlanSplitter = new EdgeCloudCollaborationPlanSplitter(this, this.iMetaManager);
        this.iFragmentGenerator = new EdgeCloudCollaborationFragmentGenerator(this.iMetaManager);
