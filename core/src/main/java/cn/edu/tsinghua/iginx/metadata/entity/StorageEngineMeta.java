...
public final class StorageEngineMeta {
  ...
  public StorageEngineMeta(long id, String ip, int port, Map<String, String> extraParams,
      String storageEngine, long createdBy) {
    this(id, ip, port, extraParams, storageEngine, createdBy, false);
  }

  public StorageEngineMeta(long id, String ip, int port, Map<String, String> extraParams,
      String storageEngine, long createdBy, boolean lastOfBatch) {
    this.id = id;
    this.ip = ip;
    this.port = port;
