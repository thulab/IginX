...
public class RestSession {
  ...
  public void addStorageEngine(String ip, int port, String type, Map<String, String> extraParams)
    ...
    AddStorageEnginesReq req = new AddStorageEnginesReq(sessionId,
        Collections.singletonList(storageEngine));
  ...
  public SessionAggregateQueryDataSet aggregateQuery(List<String> paths, long startTime,
    ...
    AggregateQueryReq req = new AggregateQueryReq(sessionId, paths, startTime, endTime,
        aggregateType);
  ...
  public SessionQueryDataSet downsampleQuery(List<String> paths, long startTime, long endTime,
      AggregateType aggregateType, long precision) {
