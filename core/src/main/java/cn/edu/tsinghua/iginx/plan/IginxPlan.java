...
public abstract class IginxPlan {
    ...
    public enum IginxPlanType {
        ...
        INSERT_NON_ALIGNED_COLUMN_RECORDS, INSERT_ALIGNED_COLUMN_RECORDS, INSERT_NON_ALIGNED_ROW_RECORDS,
        INSERT_ALIGNED_ROW_RECORDS, DELETE_DATA_IN_COLUMNS, QUERY_DATA, AGGREGATE_QUERY, MAX, MIN,
        SUM, COUNT, AVG, FIRST, LAST, DOWNSAMPLE_QUERY, DOWNSAMPLE_MAX, DOWNSAMPLE_MIN,
