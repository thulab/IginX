...
//        assertEquals("((time > 100 && time < 1000) || (a.b.d == abc) || (a.b.c >= 666) || (((a.b.e < 10 && !((a.b.f < 10))))))", statement.getFilter().toString());
  ...
  public void testParseDeleteTimeSeries() {
    ...
    DeleteTimeSeriesStatement statement = (DeleteTimeSeriesStatement) TestUtils
        .buildStatement(deleteTimeSeriesStr);
    List<String> paths = Arrays.asList("a.b.c", "a.b.d");
    assertEquals(paths, statement.getPaths());
  }
  ...
  public void testParseShowReplication() {
    ...
    ShowReplicationStatement statement = (ShowReplicationStatement) TestUtils
        .buildStatement(showReplicationStr);
  ...
  public void testParseAddStorageEngine() {
    ...
    AddStorageEngineStatement statement = (AddStorageEngineStatement) TestUtils
        .buildStatement(addStorageEngineStr);
