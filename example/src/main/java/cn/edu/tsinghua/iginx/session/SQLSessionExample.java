...
public class SQLSessionExample {
  ...
  private static final List<String> funcTypeList = Arrays
      .asList("MAX", "MIN", "FIRST_VALUE", "LAST_VALUE", "SUM", "AVG", "COUNT");
...
//        execute(addStorageEnginesStr);
  ...
  private static String buildInsertStr(String insertStrPrefix) {
    ...
    for (int i = 0; i < size; i++) {
      ...
      builder.append("\"").append(new String(RandomStringUtils.randomAlphanumeric(10).getBytes()))
          .append("\", ");
