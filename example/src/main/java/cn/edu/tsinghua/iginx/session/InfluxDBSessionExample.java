...
//    }
  ...
  private static void aggregateQuery() throws SessionException, ExecutionException {
    ...
    // MAX
    SessionAggregateQueryDataSet dataSet = session
        .aggregateQuery(paths, startTime, endTime, AggregateType.MAX);
    dataSet.print();
  ...
  private static void downsampleQuery() throws SessionException, ExecutionException {
    ...
    // MAX
    SessionQueryDataSet dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.MAX, INTERVAL * 100L);
    dataSet.print();

    // MIN
    dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.MIN, INTERVAL * 100L);
    dataSet.print();

    // FIRST_VALUE
    dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.FIRST_VALUE, INTERVAL * 100L);
    dataSet.print();

    // LAST_VALUE
    dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.LAST_VALUE, INTERVAL * 100L);
    dataSet.print();

    // COUNT
    dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.COUNT, INTERVAL * 100L);
    dataSet.print();

    // SUM
    dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.SUM, INTERVAL * 100L);
    dataSet.print();

    // AVG
    dataSet = session
        .downsampleQuery(paths, startTime, endTime, AggregateType.AVG, INTERVAL * 100L);
    dataSet.print();
