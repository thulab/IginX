...
public class ByteUtils {
  ...
  public static Object[] getColumnValuesByDataType(List<ByteBuffer> valuesList,
      List<DataType> dataTypeList, List<ByteBuffer> bitmapList, int timestampsSize) {
  ...
  public static Object[] getRowValuesByDataType(List<ByteBuffer> valuesList,
      List<DataType> dataTypeList, List<ByteBuffer> bitmapList) {
    Object[] tempValues = new Object[valuesList.size()];
    for (int i = 0; i < valuesList.size(); i++) {
