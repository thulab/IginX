...
public class SortUtils {
  ...
  public static InsertNonAlignedColumnRecordsReq sortAndBuildInsertReq(long sessionId,
      List<String> paths, long[] timestamps, Object[] valuesList,
  ...
  public static List<String> mergeAndSortPaths(List<String> paths) {
    ...
    mergedPaths
        .sort(Comparator.comparing(o -> o.contains("*") ? o.substring(0, o.indexOf("*")) : o));
    return mergedPaths;
  }
}
