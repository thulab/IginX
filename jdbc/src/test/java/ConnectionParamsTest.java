...
public class ConnectionParamsTest {
  ...
  public void testParseURL() throws IginxUrlException {
    ...
    IginXConnectionParams params = Utils
        .parseUrl(String.format(Config.IGINX_URL_PREFIX + "%s:%s/", host1, port1), properties);
    ...
    int port2 = 6999;
    params = Utils
        .parseUrl(String.format(Config.IGINX_URL_PREFIX + "%s:%s", host2, port2), properties);
