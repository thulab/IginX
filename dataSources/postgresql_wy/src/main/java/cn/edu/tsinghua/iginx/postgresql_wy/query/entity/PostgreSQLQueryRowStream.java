 ...
 * under the License.
 */
package cn.edu.tsinghua.iginx.postgresql_wy.query.entity;
...
public class PostgreSQLQueryRowStream implements RowStream {
    ...
    public PostgreSQLQueryRowStream(List<ResultSet> resultSets, List<Field> fields,List<Long> primarykeyValueList) {
