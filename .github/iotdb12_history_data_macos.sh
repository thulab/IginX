...
sh -c "wget -nv https://archive.apache.org/dist/iotdb/0.12.6/apache-iotdb-0.12.6-server-bin.zip"
...
sed -i "" "s/has_data=false/has_data=true#data_prefix=ln.wf01/" conf/config.properties