...
sudo sh -c "cd apache-iotdb-0.11.4/; nohup sbin/start-server.sh &"  > /home/runner/work/IginX/IginX/.github/actions/iotdbRunner/iotdb1Log.txt

sudo sh -c "cd apache-iotdb2-0.11.4/; nohup sbin/start-server.sh &" > /home/runner/work/IginX/IginX/.github/actions/iotdbRunner/iotdb2Log.txt
