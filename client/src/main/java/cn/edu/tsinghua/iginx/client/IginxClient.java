...
public class IginxClient {
  ...
  private static void addSingleCompleters(List<Completer> iginxCompleters,
  ...
  private static void addArgumentCompleters(List<Completer> iginxCompleters,
      List<List<String>> completers, boolean needNullCompleter) {
