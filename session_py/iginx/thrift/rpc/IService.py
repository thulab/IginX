...
class Client(Iface):
  ...
  def send_closeSession(self, req):
    self._oprot.writeMessageBegin('closeSession', TMessageType.CALL,
                                  self._seqid)
  ...
  def send_deleteColumns(self, req):
    self._oprot.writeMessageBegin('deleteColumns', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_deleteColumns(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "deleteColumns failed: unknown result")
  ...
  def send_insertColumnRecords(self, req):
    self._oprot.writeMessageBegin('insertColumnRecords', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_insertColumnRecords(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "insertColumnRecords failed: unknown result")
  ...
  def send_insertNonAlignedColumnRecords(self, req):
    self._oprot.writeMessageBegin('insertNonAlignedColumnRecords',
  ...
  def recv_insertNonAlignedColumnRecords(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "insertNonAlignedColumnRecords failed: unknown result")
  ...
  def send_insertRowRecords(self, req):
    self._oprot.writeMessageBegin('insertRowRecords', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_insertRowRecords(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "insertRowRecords failed: unknown result")
  ...
  def send_insertNonAlignedRowRecords(self, req):
    self._oprot.writeMessageBegin('insertNonAlignedRowRecords',
                                  TMessageType.CALL, self._seqid)
  ...
  def recv_insertNonAlignedRowRecords(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "insertNonAlignedRowRecords failed: unknown result")
  ...
  def send_deleteDataInColumns(self, req):
    self._oprot.writeMessageBegin('deleteDataInColumns', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_deleteDataInColumns(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "deleteDataInColumns failed: unknown result")
  ...
  def recv_queryData(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "queryData failed: unknown result")
  ...
  def send_addStorageEngines(self, req):
    self._oprot.writeMessageBegin('addStorageEngines', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_addStorageEngines(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "addStorageEngines failed: unknown result")
  ...
  def send_aggregateQuery(self, req):
    self._oprot.writeMessageBegin('aggregateQuery', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_aggregateQuery(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "aggregateQuery failed: unknown result")
  ...
  def recv_lastQuery(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "lastQuery failed: unknown result")
  ...
  def send_downsampleQuery(self, req):
    self._oprot.writeMessageBegin('downsampleQuery', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_downsampleQuery(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "downsampleQuery failed: unknown result")
  ...
  def send_getReplicaNum(self, req):
    self._oprot.writeMessageBegin('getReplicaNum', TMessageType.CALL,
                                  self._seqid)
  ...
  def recv_getReplicaNum(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "getReplicaNum failed: unknown result")
  ...
  def recv_executeSql(self):
    ...
    if result.success is not None:
      return result.success
    raise TApplicationException(TApplicationException.MISSING_RESULT,
                                "executeSql failed: unknown result")
...
class Processor(Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap[
      "insertColumnRecords"] = Processor.process_insertColumnRecords
    self._processMap[
      "insertNonAlignedColumnRecords"] = Processor.process_insertNonAlignedColumnRecords
    self._processMap["insertRowRecords"] = Processor.process_insertRowRecords
    self._processMap[
      "insertNonAlignedRowRecords"] = Processor.process_insertNonAlignedRowRecords
    self._processMap[
      "deleteDataInColumns"] = Processor.process_deleteDataInColumns
...
insertNonAlignedColumnRecords_args.thrift_spec = (
  None,  # 0
  (1, TType.STRUCT, 'req', [InsertNonAlignedColumnRecordsReq, None], None,),
  # 1
)
