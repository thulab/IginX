...
class Status(object):
  ...
  def write(self, oprot):
    ...
    if self.message is not None:
      ...
      oprot.writeString(self.message.encode('utf-8') if sys.version_info[
                                                          0] == 2 else self.message)
      oprot.writeFieldEnd()
...
class OpenSessionReq(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.username = iprot.readString().decode('utf-8') if \
            sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
          self.password = iprot.readString().decode('utf-8') if \
            sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.username is not None:
      ...
      oprot.writeString(self.username.encode('utf-8') if sys.version_info[
                                                           0] == 2 else self.username)
      oprot.writeFieldEnd()
    if self.password is not None:
      oprot.writeFieldBegin('password', TType.STRING, 2)
      oprot.writeString(self.password.encode('utf-8') if sys.version_info[
                                                           0] == 2 else self.password)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i11 in range(_size7):
            _elem12 = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
...
class InsertColumnRecordsReq(object):
  ...
  def __init__(self, sessionId=None, paths=None, timestamps=None,
      valuesList=None, bitmapList=None, dataTypeList=None,
      attributesList=None, ):
    self.sessionId = sessionId
    self.paths = paths
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i18 in range(_size14):
            _elem19 = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
        ...
        if ftype == TType.LIST:
          ...
          for _i42 in range(_size38):
            ...
            for _i48 in range(_size44):
              _key49 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
              _val50 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.paths is not None:
      ...
      for iter51 in self.paths:
        oprot.writeString(
            iter51.encode('utf-8') if sys.version_info[0] == 2 else iter51)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.attributesList is not None:
      ...
      for iter55 in self.attributesList:
        ...
        for kiter56, viter57 in iter55.items():
          oprot.writeString(
              kiter56.encode('utf-8') if sys.version_info[0] == 2 else kiter56)
          oprot.writeString(
              viter57.encode('utf-8') if sys.version_info[0] == 2 else viter57)
        oprot.writeMapEnd()
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i62 in range(_size58):
            _elem63 = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
        ...
        if ftype == TType.LIST:
          ...
          for _i86 in range(_size82):
            ...
            for _i92 in range(_size88):
              _key93 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
              _val94 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.paths is not None:
      ...
      for iter95 in self.paths:
        oprot.writeString(
            iter95.encode('utf-8') if sys.version_info[0] == 2 else iter95)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.timestamps is not None:
      oprot.writeFieldBegin('timestamps', TType.STRING, 3)
    ...
    if self.attributesList is not None:
      ...
      for iter99 in self.attributesList:
        ...
        for kiter100, viter101 in iter99.items():
          oprot.writeString(
              kiter100.encode('utf-8') if sys.version_info[
                                            0] == 2 else kiter100)
          oprot.writeString(
              viter101.encode('utf-8') if sys.version_info[
                                            0] == 2 else viter101)
        oprot.writeMapEnd()
      oprot.writeListEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i106 in range(_size102):
            _elem107 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
        ...
        if ftype == TType.LIST:
          ...
          for _i130 in range(_size126):
            ...
            for _i136 in range(_size132):
              _key137 = iprot.readString().decode('utf-8') if sys.version_info[
                                                                0] == 2 else iprot.readString()
              _val138 = iprot.readString().decode('utf-8') if sys.version_info[
                                                                0] == 2 else iprot.readString()
    ...
    if self.attributesList is not None:
      ...
      for iter143 in self.attributesList:
        ...
        for kiter144, viter145 in iter143.items():
          oprot.writeString(
              kiter144.encode('utf-8') if sys.version_info[
                                            0] == 2 else kiter144)
          oprot.writeString(
              viter145.encode('utf-8') if sys.version_info[
                                            0] == 2 else viter145)
        oprot.writeMapEnd()
      oprot.writeListEnd()
      oprot.writeFieldEnd()
        ...
        if ftype == TType.LIST:
          ...
          for _i174 in range(_size170):
            ...
            for _i180 in range(_size176):
              _key181 = iprot.readString().decode('utf-8') if sys.version_info[
                                                                0] == 2 else iprot.readString()
              _val182 = iprot.readString().decode('utf-8') if sys.version_info[
                                                                0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.paths is not None:
      ...
      for iter183 in self.paths:
        oprot.writeString(
            iter183.encode('utf-8') if sys.version_info[0] == 2 else iter183)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.timestamps is not None:
      oprot.writeFieldBegin('timestamps', TType.STRING, 3)
    ...
    if self.attributesList is not None:
      ...
      for iter187 in self.attributesList:
        ...
        for kiter188, viter189 in iter187.items():
          oprot.writeString(
              kiter188.encode('utf-8') if sys.version_info[
                                            0] == 2 else kiter188)
          oprot.writeString(
              viter189.encode('utf-8') if sys.version_info[
                                            0] == 2 else viter189)
        oprot.writeMapEnd()
      oprot.writeListEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i194 in range(_size190):
            _elem195 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.paths is not None:
      ...
      for iter196 in self.paths:
        oprot.writeString(
            iter196.encode('utf-8') if sys.version_info[0] == 2 else iter196)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i215 in range(_size211):
            _elem216 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i222 in range(_size218):
            _elem223 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.paths is not None:
      ...
      for iter230 in self.paths:
        oprot.writeString(
            iter230.encode('utf-8') if sys.version_info[0] == 2 else iter230)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.dataTypeList is not None:
  ...
  def validate(self):
    ...
    if self.storageEngines is None:
      raise TProtocolException(
          message='Required field storageEngines is unset!')
    return
...
class StorageEngine(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.ip = iprot.readString().decode('utf-8') if sys.version_info[
                                                            0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        ...
        if ftype == TType.STRING:
          self.type = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.MAP:
          ...
          for _i243 in range(_size239):
            _key244 = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
            _val245 = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i252 in range(_size248):
            _elem253 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
...
class AggregateQueryResp(object):
  ...
  def __init__(self, status=None, paths=None, dataTypeList=None,
      timestamps=None, valuesList=None, ):
    self.status = status
    self.paths = paths
    self.dataTypeList = dataTypeList
    self.timestamps = timestamps
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i273 in range(_size269):
            _elem274 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i280 in range(_size276):
            _elem281 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
...
class DownsampleQueryReq(object):
  ...
  def __init__(self, sessionId=None, paths=None, startTime=None, endTime=None,
      aggregateType=None, precision=None, ):
    self.sessionId = sessionId
    self.paths = paths
    self.startTime = startTime
    self.endTime = endTime
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i294 in range(_size290):
            _elem295 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.paths is not None:
      ...
      for iter296 in self.paths:
        oprot.writeString(
            iter296.encode('utf-8') if sys.version_info[0] == 2 else iter296)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.startTime is not None:
      oprot.writeFieldBegin('startTime', TType.I64, 3)
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i301 in range(_size297):
            _elem302 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i315 in range(_size311):
            _elem316 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
...
class ExecuteSqlReq(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.statement = iprot.readString().decode('utf-8') if \
            sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.statement is not None:
      ...
      oprot.writeString(self.statement.encode('utf-8') if sys.version_info[
                                                            0] == 2 else self.statement)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class ExecuteSqlResp(object):
  ...
  def __init__(self, status=None, type=None, paths=None, dataTypeList=None,
      queryDataSet=None, timestamps=None, valuesList=None, replicaNum=None,
      pointsNum=None, aggregateType=None, parseErrorMsg=None, limit=None,
      offset=None, orderByPath=None, ascending=None, iginxInfos=None,
      storageEngineInfos=None, metaStorageInfos=None,
      localMetaStorageInfo=None, ):
    self.status = status
    self.type = type
    self.paths = paths
    self.dataTypeList = dataTypeList
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i329 in range(_size325):
            _elem330 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
        ...
        if ftype == TType.STRING:
          self.parseErrorMsg = iprot.readString().decode('utf-8') if \
            sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 12:
        ...
        if ftype == TType.STRING:
          self.orderByPath = iprot.readString().decode('utf-8') if \
            sys.version_info[0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 15:
  ...
  def write(self, oprot):
    ...
    if self.parseErrorMsg is not None:
      ...
      oprot.writeString(self.parseErrorMsg.encode('utf-8') if sys.version_info[
                                                                0] == 2 else self.parseErrorMsg)
      oprot.writeFieldEnd()
    ...
    if self.orderByPath is not None:
      ...
      oprot.writeString(self.orderByPath.encode('utf-8') if sys.version_info[
                                                              0] == 2 else self.orderByPath)
      oprot.writeFieldEnd()
...
class UpdateUserReq(object):
  ...
  def __init__(self, sessionId=None, username=None, password=None,
      auths=None, ):
    self.sessionId = sessionId
    self.username = username
    self.password = password
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i378 in range(_size374):
            _elem379 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
  ...
  def write(self, oprot):
    ...
    if self.usernames is not None:
      ...
      for iter380 in self.usernames:
        oprot.writeString(
            iter380.encode('utf-8') if sys.version_info[0] == 2 else iter380)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i385 in range(_size381):
            _elem386 = iprot.readString().decode('utf-8') if sys.version_info[
                                                               0] == 2 else iprot.readString()
...
class LocalMetaStorageInfo(object):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.path = iprot.readString().decode('utf-8') if sys.version_info[
                                                              0] == 2 else iprot.readString()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.path is not None:
      ...
      oprot.writeString(
          self.path.encode('utf-8') if sys.version_info[0] == 2 else self.path)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class GetClusterInfoResp(object):
  ...
  def __init__(self, status=None, iginxInfos=None, storageEngineInfos=None,
      metaStorageInfos=None, localMetaStorageInfo=None, ):
    self.status = status
    self.iginxInfos = iginxInfos
    self.storageEngineInfos = storageEngineInfos
    self.metaStorageInfos = metaStorageInfos
...
Status.thrift_spec = (
  ...
  (3, TType.LIST, 'subStatus', (TType.STRUCT, [Status, None], False), None,),
  # 3
)
...
AddStorageEnginesReq.thrift_spec = (
  ...
  (1, TType.I64, 'sessionId', None, None,),  # 1
  (
    2, TType.LIST, 'storageEngines',
    (TType.STRUCT, [StorageEngine, None], False),
    None,),  # 2
)
...
StorageEngine.thrift_spec = (
  ...
  (4, TType.MAP, 'extraParams',
   (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None,),  # 4
)
...
ExecuteSqlResp.thrift_spec = (
  ...
  (16, TType.LIST, 'iginxInfos', (TType.STRUCT, [IginxInfo, None], False),
   None,),  # 16
  (17, TType.LIST, 'storageEngineInfos',
   (TType.STRUCT, [StorageEngineInfo, None], False), None,),  # 17
  (18, TType.LIST, 'metaStorageInfos',
   (TType.STRUCT, [MetaStorageInfo, None], False), None,),  # 18
  (19, TType.STRUCT, 'localMetaStorageInfo', [LocalMetaStorageInfo, None],
   None,),  # 19
)
...
GetUserResp.thrift_spec = (
  ...
  (4, TType.LIST, 'auths', (TType.SET, (TType.I32, None, False), False), None,),
  # 4
)
...
GetClusterInfoResp.thrift_spec = (
  ...
  (1, TType.STRUCT, 'status', [Status, None], None,),  # 1
  (
    2, TType.LIST, 'iginxInfos', (TType.STRUCT, [IginxInfo, None], False),
    None,),
  # 2
  (3, TType.LIST, 'storageEngineInfos',
   (TType.STRUCT, [StorageEngineInfo, None], False), None,),  # 3
  (4, TType.LIST, 'metaStorageInfos',
   (TType.STRUCT, [MetaStorageInfo, None], False), None,),  # 4
  (
    5, TType.STRUCT, 'localMetaStorageInfo', [LocalMetaStorageInfo, None],
    None,),
  # 5
)
